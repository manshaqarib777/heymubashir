								...
								<form name="myForm" class="xform"  id="deliver_form" method="POST">
									...
									<div class="row">
										...
										<div class="col-sm-12 col-md-4">
											...
											<textarea class="form-control" name="person_receives" placeholder="Name who receives the package" data-toggle="tooltip" data-placement="bottom" title="Name of the person who receives the package" required></textarea>
										</div>
										<div class="col-sm-12 col-md-4">
											<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['deliver-ship7'] ?></label>
											<div class="input-group mb-3">
												<textarea class="form-control" name="name_employee" id="name_employee" placeholder="Name of the driver or dealer" data-toggle="tooltip" data-placement="bottom" title="Name of the driver or dealer" required><?php echo $user->username; ?></textarea>
											</div>
										</div>
									...
									<div class="row">	
										...
										<div class="col-sm-12 col-md-8">
											...
											<div class="row">
												...
												<button type="button" class="button" data-toggle="modal" data-target=".bs-example-modal-lg"> Open signature </button>
