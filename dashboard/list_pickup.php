					...
					<table id="zero_config" class="table table-condensed table-hover table-striped">
						...
						<tbody id="projects-tbl">
							...
							<tr>
								...
								<a  href="edit_pickup.php?do=edit_pickup&amp;action=add&amp;courier_id=<?php echo $row->id;?>&amp;username=<?php echo $row->username;?>" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['left79'] ?>"><i style="color:red" class="mdi mdi-calendar-clock"></i></a>
