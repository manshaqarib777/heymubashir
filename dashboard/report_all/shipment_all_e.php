<?php
	...
	if (isset($_GET['tgl_awal'])) {
		...
		$query = mysqli_query($con, "SELECT * FROM add_courier WHERE origin_off='".$row->name_off."' AND status_novelty='0' AND created BETWEEN '$tgl_awal' AND '$tgl_akhir' AND act_status=1
                                    ORDER BY id ASC") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>ALL SHIPPING REPORT</title>
    ...
    <body>
	   ...
	   <br>
	   <div id="title">
           All shipments | Employee: <?php echo $used; ?>
        </div>
						...
						if($count == 0) {
							...
							$suma+=$total;
								echo "  <tr>
											...
											<td width='80' height='13' align='right' valign='middle'>$suma $core->currency</td>
										</tr>";
								$no++;
							}
						}
