...
<?php $courierrow = $core->getCourier_list_Picked_up(); ?>
			...
			<div class="card-body">
				<div class="d-md-flex align-items-center">
					<div>
						...
						<h5 class="card-subtitle">Selected state: Picked up</h5>
					</div>
				</div>
				<ul class="nav nav-pills m-t-30 m-b-30">
					...
					<li class="nav-item"> <a href="all_status.php?do=status_picked_up" class="nav-link active" ><h5 class="card-title">Picked up</h5></a> </li>
