...
// *************************************************************************
	...
	if($_POST['agencys']=='ALL AGENCIES'){
		$query="SELECT a.id, a.qid, a.order_inv, a.s_name, a.r_name, a.agency, a.origin_off, a.created, a.r_hour, a.status_courier, a.pay_mode, a.service_options, a.act_status, a.status_novelty, a.r_insurance, a.r_tax, a.total_insurance, a.total_tax, a.r_custom, a.r_costtotal, a.level, a.l_price,
					b.detail_description, b.detail_qnty, b.detail_weight, b.detail_vol  FROM add_courier a, detail_addcourier b WHERE a.qid=b.id_add AND  a.created  BETWEEN '$fecha1' AND '$fecha2' AND  a.act_status='1' AND a.status_novelty='0' ORDER BY a.id ASC";
		$result=mysqli_query($con, $query);
	}else{
	$query="SELECT a.id, a.qid, a.order_inv, a.s_name, a.r_name, a.agency, a.origin_off, a.created, a.r_hour, a.status_courier, a.pay_mode, a.service_options, a.act_status, a.status_novelty, a.r_insurance, a.r_tax, a.total_insurance, a.total_tax, a.r_custom, a.r_costtotal, a.level, a.l_price,
					b.detail_description, b.detail_qnty, b.detail_weight, b.detail_vol  FROM add_courier a, detail_addcourier b WHERE a.qid=b.id_add AND a.agency='$agen' AND   a.created  BETWEEN '$fecha1' AND '$fecha2' AND  a.act_status='1' AND a.status_novelty='0' ORDER BY a.id ASC";
		$result=mysqli_query($con, $query);
	}	
?>
<!DOCTYPE html>
								...
								<div class="panel-body">
								   <table style="width: 100%;">
									...
									<table width="100%" border="0">
										...
										<tr>
										<td colspan="5">
										<p><strong>Who receives:________________________________________</strong></p>
										</td>
									  </tr>
									</table>
								</div>	
