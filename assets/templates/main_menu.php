...
<div class="theme-main-menu theme-menu-one menu-white main-p-color">
	<div class="d-flex align-items-center">
		<div class="logo mr-auto"><a href="index.php"><?php echo ($core->logo) ? '<img src="'.SITEURL.'/uploads/'.$core->logo.'" alt="'.$core->site_name.'" class="logo" width="190" height="50"/>': $core->site_name;?></a></div>
