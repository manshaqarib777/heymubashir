...
$action = (isset($_REQUEST['action'])&& $_REQUEST['action'] !=NULL)?$_REQUEST['action']:'';
	...
	<tr>
		<td colspan='12'>		
			<div class="btn-der">
				<br><br><br>
				<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><span class="mdi mdi-book-plus"></span> <?php echo $lang['left231'] ?></button>
			</div>
		</td>
		<br><br>
	</tr>
			...
			<div class="row">
				<div class="col-lg-12 col-xl-4">
					<div class="card card-hover">
						<div class="card-body">	
							<h4 class="card-title"> Volumetric or normal weight calculation</h4>
							<br><br>
							<div class="row">
								<div class="col-sm-6 col-md-6">										
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" name="r_weight" value="<?php echo $sumweight; ?>" readonly>
									</div>
								</div>
								...
								<div class="col-sm-6 col-md-6">										
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" name="r_qnty" value="<?php echo $sumr_qnty; ?>" readonly>
									</div>
								</div>
								...
								<div class="col-sm-6 col-md-6">										
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" name="v_weight" value="<?php echo $sumvol; ?>" readonly>
									</div>
								</div>
								...
								<div class="col-sm-6 col-md-6">										
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" name="t_weight" value="<?php echo $calculate_weight; ?>" readonly>
									</div>
								</div>	
							...
							<div class="row">
								...
								<div class="col-sm-12 col-md-4" >
									...
									<div class="input-group">
										<input type="text" class="form-control" name="total_tax"  id="total_impuesto" value="0" readonly>
									</div>
								</div>
								<div class="col-sm-12 col-md-4" >
									...
									<div class="input-group">
										<input type="text" class="form-control" name="total_insurance"  id="tinsurance"  value="0" readonly>
									</div>
								</div>
								<div class="col-sm-12 col-md-4" >
									...
									<div class="input-group">
										<input type="text" class="form-control" name="l_price"  id="total_libra" value="0" readonly>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-12 col-md-4">
									...
									<div class="input-group">
										<input type="text" class="form-control is-invalid"  name="r_custom"  id="declarado" onkeyup="calcular()" value="0">
									</div>
								</div>	
								<div class="col-sm-12 col-md-4">
