<?php
	...
	if (isset($_GET['tgl_awal'])) {
		...
		$query = mysqli_query($con, "SELECT * FROM add_courier WHERE origin_off='".$row->name_off."' AND status_courier='Pending' AND status_novelty='0' AND  created  BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id ASC") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>PENDING SHIPPING REPORT</title>
    ...
    <body>
	   ...
	   <br>
	   <div id="title">
          Pending Shipments | Employee: <?php echo $used; ?>
        </div>
						...
						if($count == 0) {
							...
							$suma+=$total;
								echo "  <tr>
											...
											<td width='120' height='13' align='center' valign='middle'>$row[order_inv]</td>
											<td width='170' height='13' align='center' valign='middle'>$row[s_name]</td>
											<td width='70' height='13' align='center' valign='middle'>$row[created]</td>
