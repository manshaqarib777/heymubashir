...
<?php $courierrow = $core->getCourier_list_Received_Office(); ?>
			...
			<div class="card-body">
				<div class="d-md-flex align-items-center">
					<div>
						...
						<h5 class="card-subtitle">Selected state: Received Office</h5>
					</div>
				</div>
				<ul class="nav nav-pills m-t-30 m-b-30">
					...
					<li class="nav-item"> <a href="all_status.php?do=status_received_office" class="nav-link active" ><h5 class="card-title">Received Office</h5></a> </li>
