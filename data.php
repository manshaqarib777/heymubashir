<?php
    ...
    if (isset($_POST['step-5']))
    {
		...
		$r_additional_data=json_encode($r_additional_data);
			$sql="UPDATE `add_courier` SET `s_name`='".$_POST['s_name']."',`address`='".$_POST['address']."',`phone`='".$_POST['phone']."',`email`='".$_POST['email']."',`r_name`='".$_POST['r_name']."',`r_email`='".$_POST['r_email']."',`r_address`='".$_POST['r_address']."',`r_addresspickup`='".$_POST['r_addresspickup']."',`r_phone`='".$_POST['r_phone']."',`city`='".$_POST['city']."',`lastname`='".$_POST['lastname']."',`r_lastname`='".$_POST['r_lastname']."',`street`='".$_POST['street']."',`r_street`='".$_POST['r_street']."',`addresspickup`='".$_POST['addresspickup']."',`pickupdetails`='".$_POST['pickupdetails']."',`r_pickupdetails`='".$_POST['r_pickupdetails']."',`refrence_no`='".$_POST['refrence_no']."',`r_refrence_no`='".$_POST['r_refrence_no']."',`access_restriction_limitation`='".$_POST['access_restriction_limitation']."',`access_restriction_limitation_height`='".$_POST['access_restriction_limitation_height']."',`r_access_restriction_limitation`='".$_POST['r_access_restriction_limitation']."',`r_access_restriction_limitation_height`='".$_POST['r_access_restriction_limitation_height']."',`additional_data`='".$additional_data."',`r_additional_data`='".$r_additional_data."',`company`='".$_POST['company']."',`r_company`='".$_POST['r_company']."',`city`='".$_POST['city']."',`country`='".$_POST['country']."',`r_city`='".$_POST['r_city']."',`r_country`='".$_POST['r_country']."' WHERE id=".$_SESSION['courier_id'];
	    	if (mysqli_query($con, $sql)) {
    ...
    if (isset($_POST['step-6']))
    {
		...
		if(file_exists($_FILES['shipment_file']['tmp_name']) || is_uploaded_file($_FILES['shipment_file']['tmp_name'])) {
			...
			$sql="UPDATE `add_courier` SET `person_contact_no`='".$_POST['person_contact_no']."',`truck_lift`='".$_POST['truck_lift']."',`floor_pickup`='".$_POST['floor_pickup']."',`deposite_collection`='".$_POST['deposite_collection']."',`deliver_goods`='".$_POST['deliver_goods']."',`phone_notification`='".$_POST['phone_notification']."',`transport_insurance`='".$_POST['transport_insurance']."',`floor_delivery`='".$_POST['floor_delivery']."',`driver_deposite_goods`='".$_POST['driver_deposite_goods']."',`green_tree`='".$_POST['green_tree']."',`shipment_type`='".$_POST['shipment_type']."',`dangerous_goods`='".$_POST['dangerous_goods']."',`un_number`='".$_POST['un_number']."',`packaging_amount`='".$_POST['packaging_amount']."',`dangerous_goods_points`='".$_POST['dangerous_goods_points']."',`temprature_controlled_goods`='".$_POST['temprature_controlled_goods']."',`temprature`='".$_POST['temprature']."',`transport_company`='".$_POST['transport_company']."',`transport_company_goods`='".$_POST['transport_company_goods']."',`crane_required_picking`='".$_POST['crane_required_picking']."',`crane_required_uploading`='".$_POST['crane_required_uploading']."',`shipment_file`='".$shipment_file."' WHERE id=".$_SESSION['courier_id'];
