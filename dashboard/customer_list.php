                                    ...
                                    <table id="zero_config" class="table table-condensed table-hover table-striped">
										...
										<tbody id="projects-tbl">
											...
											<tr>
												...
												<?php }else{ ?>
													<a href="cargo_shipping.php?do=add_courier&amp;action=add&amp;id=<?php echo $row->id;?>" class='btn waves-effect waves-light btn-outline-info top-btn' data-toggle="tooltip" data-placement="top" title="<?php echo $lang['tooladd'] ?>" ><span class="ti-package"></span></a>													
												<?php } ?>	
												</td>
											</tr>
											<?php endforeach;?>
