...
<?php $quoterow = $core->getQuote_list(); ?>
					...
					<table id="zero_config" class="table table-condensed table-hover table-striped">
						<thead>
							<tr>
								...
								<th class="text-center"><b><?php echo $lang['left253'] ?></b></th>
								<th class="text-center"><b><?php echo $lang['left254'] ?></b></th>
						...
						<tbody id="projects-tbl">
							...
							<tr>
								...
								<td class="text-center"><?php echo $row->your_purchase;?></td>
								<td class="text-center"><?php echo $row->your_quote;?></td>																
								...
								<td align='center'>
								<a  href="edit_quote.php?do=edit_quote&amp;action=edit&amp;id=<?php echo $row->id;?>" ><button type="button" class="btn btn-sm btn-icon btn-success btn-outline"><?php echo $lang['left258'] ?></button></a>
								</td>
							</tr>
							<?php endforeach;?>
							<?php unset($row);?>
