...
<div id="page-wrap">
    <table width="100%">
        <tr>
            ...
            <div id="logo">
                    <?php echo "<img src='".$core->site_url."/uploads/logo.png' border='0' width='190' height='70'>";  ?>
            </td>
    ...
    <div style="text-align: center;border: 3px solid black; padding: 10px;">
    ...
    <table id="items">
        <tr>
            ...
            <th align="center"><p style="color:white;"><?php echo $lang['inv-shipping11'] ?></p></th>
            <th align="center"><p style="color:white;"><?php echo $lang['inv-shipping12'] ?></p></th>
        ...
        <tr>
            <td class="blank"><h5>1 Palette</h5> </td>
            <td  align="right" colspan="2" class="total-line"><?php echo $lang['inv-shipping14'] ?></td>
            <td  align="right" class="total-value"><div id="total"><span class="price"> <?php echo $row->cargo_without_vat; ?> </span> </div></td>
        </tr>
        <tr>
            <td  align="right" class="blank"> </td>
            <td  align="right" colspan="2" class="total-line"><?php echo $lang['inv-shipping15'] ?> +</td>
            <td  align="right" class="total-value"><div id="total"> <?php echo round_out($tax); ?> </div></td>
        </tr>
        <tr>
            <td  align="right" class="blank"> </td>
            <td  align="right" colspan="2" class="total-line"><?php echo $lang['inv-shipping16'] ?> +</td>
            <td  align="right" class="total-value"><div id="total"> <?php echo round_out($totalinsurance); ?> </div></td>
        </tr>
        <tr>
            <td class="blank"> </td>
            <td align="right" colspan="2" class="total-line balance"><p style="color:white;"><?php echo $lang['inv-shipping17'] ?> </p></td>
            <td align="right" class="total-value balance"><div class="due"> <p style="color:white;"><b><?php echo $core->currency;?> <?php echo round_out($row->cargo_vat); ?> </b></p></div></td>
        </tr>
    </table>
...
<!--    end related transactions -->
        ...
        <div id="terms">
            ...
            <table id="signing">
                <tr class="noBorder">
                    <td align="center"><h4 style='margin-top: -27px;'><?php echo $row->person_receives;?></h4></td>
                    <td align="center">
                        <?php 
                        if (@getimagesize("../doc_signs/".$row->id.".png")) {?>
                            <h4 style='margin-top: -40px;'><img src="../doc_signs/<?php echo $row->id;?>.png" class="img-fluid" width='100px;'></h4>
                        <?php } else {?>
                            <h4 style='margin-top: -27px;'></h4>
                        <?php }?>
                    </td>
                </tr>
                <tr class="noBorder">
