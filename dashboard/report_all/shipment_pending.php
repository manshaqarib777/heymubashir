<?php
	...
	if (isset($_GET['tgl_awal'])) {
		...
		$query = mysqli_query($con, "SELECT * FROM add_courier WHERE status_courier='Pending' AND status_novelty='0' AND  created  BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id ASC") 
