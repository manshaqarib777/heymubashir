...
<?php $allshiprow = $core->getDeliveredconsol();?>
<?php $allshipemployeerow = $user->getDeliveredconsolemployee();?>
<div class="row">
	<!-- Column -->
		...
		<div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<div class="example">
							<h4 class="card-title m-t-30"><?php echo $lang['langs_085'] ?></h4>
							<form id="dForm" class="form-horizontal" method="GET" action="report_all/consolidated_delivered.php" target="_blank">
					...
					<table id="zero_config" class="table table-condensed table-hover table-striped">
						<thead>
							<tr>
								...
								<th class="text-center"><b><?php echo $lang['langs_088'] ?></b></th>
								<th class="text-center"><b><?php echo $lang['langs_089'] ?></b></th>
						...
						<tbody id="projects-tbl">
							...
							<tr>
								...
								<td class="text-center"><?php echo $row->r_email;?></td>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<div class="example">
							<h4 class="card-title m-t-30"><?php echo $lang['langs_085'] ?></h4>
							<form id="dForm" class="form-horizontal" method="GET" action="report_all/consolidated_delivered_e.php" target="_blank">
								<div class="input-daterange input-group" id="date-range">
									<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="tgl_awal"autocomplete="off" placeholder="From Date" width="276" /> 
									&nbsp;
										<span class="input-group-text bg-info b-0 text-white"><?php echo $lang['langs_01036'] ?></span>
