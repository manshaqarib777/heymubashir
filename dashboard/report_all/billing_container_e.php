<?php
	...
	if (isset($_GET['tgl_awal'])) {
		...
		$query = mysqli_query($con, "SELECT a.id,a.order_inv, a.pay_mode,a.created,a.origin_off,b.idcon,b.created,b.tprice
                                    FROM add_container as a INNER JOIN detail_container as b ON a.id=b.idcon
                                    WHERE a.origin_off='".$row->name_off."' AND a.created BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ORDER BY a.id ASC") 
