<?php
	...
	if (isset($_GET['tgl_awal'])) {
		$no    = 1;
		$query = mysqli_query($con, "SELECT * FROM consolidate WHERE code_off='".$row->name_off."' AND act_status='2' AND  created  BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id ASC") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>BILLING CONSOLIDATED REPORT</title>
						...
						if($count == 0) {
							...
							$neto=$neto+$row['r_costtotal'];
								echo "  <tr>
											...
											<td width='150' height='13' align='right' valign='middle'>$row[r_costtotal] $core->currency</td>
										</tr>
										<tr>
...
<?php
$filename="billing consolidated.pdf"; 
