...
<?php $courierrow = $core->getCourier_list_Pre_Alert(); ?>
			...
			<div class="card-body">
				<div class="d-md-flex align-items-center">
					<div>
						...
						<h5 class="card-subtitle">Selected state: Pre Alert</h5>
					</div>
				</div>
				<ul class="nav nav-pills m-t-30 m-b-30">
					...
					<li class="nav-item"> <a href="all_status.php?do=status_pre_alert" class="nav-link active" ><h5 class="card-title">Pre Alert</h5></a> </li>
								...
								<table id="zero_config" class="table table-striped">
									...
									<tbody id="projects-tbl">
										...
										<tr class="card-hover">		
											...
											<td><span style="background: <?php echo $row->color; ?>;"  class="label label-large" ><?php echo $row->status_prealert;?></span></td>
