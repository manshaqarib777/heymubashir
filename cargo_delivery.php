...
<div id="preloader">
        ...
        <div class="row mt-5">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="radio" checked name="person_contact_no" value="yes">
                                        <label>&nbsp;Yes</label>
                                        <input class="ml-3" type="radio" checked name="person_contact_no" value="no">
                                        <label>&nbsp;No</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 py-2" style="background-color: #f9fdfd;">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="radio" checked name="truck_lift" value="yes">
                                        <label>&nbsp;Yes</label>
                                        <input class="ml-3" type="radio" checked name="truck_lift" value="no">
                                        <label>&nbsp;No</label>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="cargo-label m-0 py-1 font-16 color">
                                            Floor pickkup at the shipper <i class="fa fa-info-circle"
                                                ...
                                                aria-hidden="true"></i></label>
                                        <br>
                                        <input type="radio" checked name="floor_pickup" value="yes">
                                        <label>&nbsp;Yes</label>
                                        <input class="ml-3" type="radio" checked name="floor_pickup" value="no">
                                        <label>&nbsp;No</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 py-2" style="background-color: #f9fdfd;">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="radio" checked name="deposite_collection" value="yes">
                                        <label>&nbsp;Yes</label>
                                        <input class="ml-3" type="radio" checked name="deposite_collection" value="no">
                                        <label>&nbsp;No</label>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="cargo-label m-0 py-1 font-16 color">
                                            Deliver goods neutralized? <i class="fa fa-info-circle"
                                                ...
                                                aria-hidden="true"></i></label>
                                        <br>
                                        <input type="radio" checked name="deliver_goods" value="yes">
                                        <label>&nbsp;Yes</label>
                                        <input class="ml-3" type="radio" checked name="deliver_goods" value="no">
                                        <label>&nbsp;No</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="cargo-label m-0 py-1 font-16 color">
                                        Phone notification receiver <i class="fa fa-info-circle" data-toggle="tooltip"
                                            data-placement="top" title="" aria-hidden="true"></i></label>
                                    <br>
                                    <input type="radio" checked name="phone_notification" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="phone_notification" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="cargo-label m-0 py-1 font-16 color">
                                        Transport insurance <i class="fa fa-info-circle" data-toggle="tooltip"
                                            data-placement="top" title="" aria-hidden="true"></i></label>
                                    <br>
                                    <input type="radio" checked name="transport_insurance" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="transport_insurance" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="cargo-label m-0 py-1 font-16 color">
                                        Floor delivery at the receiver <i class="fa fa-info-circle"
                                            ...
                                            aria-hidden="true"></i></label>
                                    <br>
                                    <input type="radio" checked name="floor_delivery" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="floor_delivery" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="cargo-label m-0 py-1 font-16 color" style="font-size: 15px;">
                                        Can the driver deposit the goods at the receiver?<i class="fa fa-info-circle"
                                            ...
                                            aria-hidden="true"></i></label>
                                    <br>
                                    <input type="radio" checked name="driver_deposite_goods" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="driver_deposite_goods" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                ...
                <!--                <input class="mb-4" type="radio" checked name="green_tree" value="yes">-->
                <!--                <label>&nbsp;Yes</label>-->
                <!--                <input class="ml-3 mb-3" type="radio" checked name="green_tree" value="no">-->
                <!--                <label>&nbsp;No</label>-->
                <!--            </div>-->
...
-->
                ...
                <div class="row mt-5 mb-4">
                    ...
                    <div class="col-6">
                        <a href="addresses.html"><input type="button" class="btn btn-cargo py-2 px-5" id="ButtonNext"
                                style="background-color:#f7f4f3; font-size: 18px; color: #899099; clip-path: polygon(0 34%, 14% 0, 100% 0, 100% 100%, 0% 100%);"
                                value="Back"></input></a>
                    </div>

                    <div class="col-6 text-right">
                        <input type="submit" name="step-6" value="step-6" class="btn btn-cargo py-2 px-5" id="ButtonNext"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control border-input rounded-0"
                                        ...
                                        <option style="font-size: 14px;">Own delivery slip</option>
                                        <option style="font-size: 14px;">Document for dangerous goods</option>
                                        <option style="font-size: 14px;">Picture of the goods</option>
                                        <option style="font-size: 14px;">Other document</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <br>
                                <input type="radio" checked name="dangerous_goods" value="yes">
                                <label>&nbsp;Yes</label>
                                <input class="ml-3" type="radio" checked name="dangerous_goods" value="no">
                                <label>&nbsp;No</label>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-0 border-input bg-transparent"
                                        placeholder="" aria-describedby="helpId" name="un_number">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-0 border-input bg-transparent"
                                        placeholder="" aria-describedby="helpId" name="packaging_amount">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-0 border-input bg-transparent"
                                        placeholder="" aria-describedby="helpId" name="dangerous_goods_points">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <br>
                                <input type="radio" checked name="temprature_controlled_goods" value="yes">
                                <label>&nbsp;Yes</label>
                                <input class="ml-3" type="radio" checked name="temprature_controlled_goods" value="no">
                                <label>&nbsp;No</label>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-0 border-input bg-transparent"
                                        placeholder="" aria-describedby="helpId" name="temprature">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    <label for="" class="cargo-label m-0 py-1 font-16 color" style="font-size: 15px;">
                                        ...
                                        the goods?</label>
                                    <br>
                                    <input type="radio" checked name="transport_company" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="transport_company" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    <label for="" class="cargo-label m-0 py-1 font-16 color" style="font-size: 15px;">
                                        ...
                                        goods?</label>
                                    <br>
                                    <input type="radio" checked name="transport_company_goods" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="transport_company_goods" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="radio" checked name="crane_required_picking" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="crane_required_picking" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="radio" checked name="crane_required_uploading" value="yes">
                                    <label>&nbsp;Yes</label>
                                    <input class="ml-3" type="radio" checked name="crane_required_uploading" value="no">
                                    <label>&nbsp;No</label>
                                </div>
                            </div>
                        </div>
