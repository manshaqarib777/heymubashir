    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
			...
			<div class="container-fluid">
				...
				<form id="admin_form" method="post">
					<div class="row">
						<div class="col-sm-12 col-lg-6">
							<div class="card">
								<div class="card-body">
								Tracking shop purchase: <strong><?php echo $rows->order_purchase;?></strong><br>
								<h4 class="card-title">Sender Data:
								<!-- Collapse buttons -->
								<a class="btn btn-default" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">See Fields</a>
									...
									<div class="row">									
										...
										<div class="col-12 col-sm-6 col-md-6">
											<div class="form-group">
												...
												<input class="custom-select col-12" name="agency" placeholder="--Selecionar Agencia--" list="browsersag" autocomplete="off" required="required">
									...
									<div class="row">
										<div class="col-sm-12 col-md-4">
											...
											<div class="input-group">
												<input class="custom-select col-12" name="package" value="<?php echo $rows->package;?>" placeholder="--Seleccionar paquete--" list="browsers1" autocomplete="off" required="required">
										...
										<div class="col-sm-12 col-md-4">
											...
											<div class="input-group">
												<input class="custom-select col-12" name="courier" value="<?php echo $rows->courier;?>" placeholder="--Seleccionar empresa envío--" list="browsers2" autocomplete="off" required="required">
									...
									<div class="row"> 									
										<div class="col-sm-12 col-md-4">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" name="deli_time" value="<?php echo $rows->deli_time;?>" placeholder="--Select Delivery Time--" list="browsersstatus" autocomplete="off" required="required">
										...
										<div class="col-sm-12 col-md-4">
											...
											<div class="input-group mb-3">
												<input class="custom-select col-12" name="service_options" value="<?php echo $rows->service_options;?>" placeholder="--Select Shipping Mode--" list="browsers3" autocomplete="off" required="required">
										...
										<div class="col-sm-12 col-md-4">
											...
											<div class="input-group mb-3">
												<input class="form-control" name="supplier" value="<?php echo $rows->supplier; ?>" readonly required="required">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12 col-md-6">
											...
											<div class="input-group">
												<input class="form-control" name="itemcat"  placeholder="--Select Category--" list="browsers4" autocomplete="off" required="required">
										...
										<div class="col-sm-12 col-md-12">
											...
											<div class="input-group mb-3">
												 <div id="editor">
													<textarea name="package_invoice" id="summernote" style="margin-top: 30px;" placeholder="Type some text">
													<?php echo $rows->package_invoice; ?>
													</textarea>
													<div class="label2 label-important">Copy and paste Invoice</div>
												</div>
											</div>
										</div>										
									</div>	
									...
									<div class="row">
										<div class="col-sm-12 col-md-6">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" id="searchnames"  name="r_name" value="<?php echo $rows->r_name;?>" placeholder="--Search recipient name--" required>
											</div>
										</div>
										<div class="col-sm-12 col-md-6">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-sm-12 col-md-12">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" id="search_location" placeholder="Buscar dirección en google map" value="<?php echo $rows->r_address;?>" required>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">											
												<!-- display google map -->
												<div id="geomap" style="height: 305px"></div>
											</div>
											<hr class="m-t-0 m-b-35">
										</div>
									</div>
																	...
																	<div class="row">
																		<div class="col-12 col-sm-4 col-md-4">										
																			...
																			<div class="input-group mb-3">
																				...
																				<input type="text" class="form-control" name="tracking" value="<?php echo $rows->tracking;?>">
																			</div>
																		</div>
																		...
																		<div class="col-sm-12 col-md-3">
																			...
																			<div class="input-group">
																				<input type="text" class="form-control" name="r_custom"  id="declarado" onkeyup="calcular()" value="<?php echo $rows->r_custom;?>">
																			</div>
																		</div>	
											...
											<div class="form-actions">
												<div class="card-body">
													<div class="text-right">
														...
														<button type="submit" name="dosubmit" class="btn btn-success"> <i class="ti-reload"></i>&nbsp; <?php echo $lang['edit-courieronline18'] ?></button>
                ...
                <?php echo Core::doForm("processUCourierpre");?>
				<?php break;?>
				<?php endswitch;?>
            </div>
			 <!-- Row -->
							...
							<form id="readmin_form" method="post">
								...
								<fieldset class="col-md-12">
									...
									<div class="form-group">
										...
										<input name="act_status"  value="5" type="hidden">
										<input name="id" type="hidden" value="<?php echo Filter::$id;?>" />
									</div>
								</fieldset>
								<br>			
							...
							<div class="modal-body">
								<div class="row">
									...
									<div class="form-group">
										...
										<textarea class="form-control" data-toggle="tooltip" data-placement="bottom" title="Package Description" id="detail_description" name="detail_description" required><?php echo $rows->r_description;?></textarea>
									...
									<div class="col-sm-12 col-md-4">
										<div class="form-group">
											...
											<input type="number" data-toggle="tooltip" data-placement="bottom" title="Number of items" class="form-control" name="detail_qnty" value="<?php echo $rows->r_qnty;?>" required>
										</div>
									</div>
								</div>	
			...
			<script type="text/javascript">
				...
				function show_items(){
					...
					$.ajax({
						url:'ajax/add_items_courier_online.php',
						data: parametros,
