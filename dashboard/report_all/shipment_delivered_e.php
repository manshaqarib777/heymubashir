<?php
	...
	if (isset($_GET['tgl_awal'])) {
		$no    = 1;
		$query = mysqli_query($con, "SELECT * FROM add_courier WHERE origin_off='".$row->name_off."' AND status_courier='Delivered' AND status_novelty='0' AND  created  BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id ASC") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>DELIVERY DELIVERY REPORT</title>
    ...
    <body>
	   ...
	   <br>
	   <div id="title">
           Deliveries delivered | Employee: <?php echo $used; ?>
        </div>
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
						...
						<th height="20" align="center" valign="middle"><small>Driver</small></th>
						<th height="20" align="center" valign="middle"><small>Deliver date</small></th>
						...
						if($count == 0) {
							...
							$suma+=$total;
								echo "  <tr>
											...
											<td width='90' height='13' align='center' valign='middle'>$row[c_driver]</td>
											<td width='140' height='13' align='center' valign='middle'>$row[deliver_date]-$row[delivery_hour]</td>
											<td width='90' height='13' valign='middle'>$row[status_courier]</td>
											<td width='60' height='13' align='right' valign='middle'>$suma $core->currency</td>
										</tr>";
								$no++;
							}
						}
...
<?php
$filename="delivered shipment.pdf"; 
