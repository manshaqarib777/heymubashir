<?php
	...
	if (isset($_GET['tgl_awal'])) {
		$no    = 1;
		$query = mysqli_query($con, "SELECT * FROM add_courier WHERE origin_off='".$row->name_off."' AND status_prealert='Pre Alert' AND status_novelty='0' AND  act_status=1 AND created  BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id ASC") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    ...
    <body>
	   ...
	   <br>
	   <div id="title">
            Envíos pre alertas | Empleado: <?php echo $used; ?>
        </div>
