										...
										<table id="zero_config" cellpadding="0" cellspacing="0" border="0" class="table table-striped">
											<thead class="bg-secondary border-0 text-white">
												<tr class="row100 head">
													...
													<th class="th-sm"><b><?php echo $lang['booking-list15'] ?></b></th>
													<th class="th-sm"><b><?php echo $lang['booking-list16'] ?></b></th>
													<th class="th-sm"><b><?php echo $lang['booking-list17'] ?></b></th>
											...
											<tbody id="projects-tbl">
												<tr class="row100">
													...
													<td><?php echo $row->pickLocation;?></td>
													...
													<td>
														<div class='row'>
											                <?php foreach ($files as $image) { ?>
											                    <div class="col-md-3">
											                        <a href="<?php echo $image;?>" download><img src="<?php echo $image;?>" style='max-width:100%;height:100px'></a>
											                    </div>
											                <?php } ?>
											            </div>
											        </td>
													<td><?php echo $row->person_receives;?></td>
								                    <td>
								                        <?php if (@getimagesize("doc_signs/".$row->id.".png")) {?>
								                        	<a href="doc_signs/<?php echo $row->id;?>.png" download><img src="doc_signs/<?php echo $row->id;?>.png" class="img-fluid" width='100px;'></a>
								                        <?php }?>
								                    </td>
													<td><?php echo $row->r_curren;?> <span class="text-black"><strong><?php echo $row->cargo_vat;?></strong></td>
