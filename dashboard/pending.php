...
<?php $allshipemployeerow = $user->getPendingshipemployee();?>
<div class="row">
	<!-- Column -->
		...
		<div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<div class="example">
							<h4 class="card-title m-t-30"><?php echo $lang['langs_01035'] ?></h4>
							<form id="dForm" class="form-horizontal" method="GET" action="report_all/shipment_pending.php" target="_blank">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<div class="example">
							<h4 class="card-title m-t-30"><?php echo $lang['langs_01035'] ?></h4>
							<form id="dForm" class="form-horizontal" method="GET" action="report_all/shipment_pending_e.php" target="_blank">
								<div class="input-daterange input-group" id="date-range">
									<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="tgl_awal"autocomplete="off" placeholder="From Date" width="276" /> 
									&nbsp;
										<span class="input-group-text bg-info b-0 text-white"><?php echo $lang['langs_01036'] ?></span>
