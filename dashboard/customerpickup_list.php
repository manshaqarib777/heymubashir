                                    ...
                                    <table id="zero_config" class="table table-condensed table-hover table-striped">
										...
										<tbody id="projects-tbl">
											...
											<tr>
												...
												<?php }else{ ?>
													<a href="courier.php?do=list_courier_by_id&amp;username=<?php echo $row->username;?>" class='btn waves-effect waves-light btn-outline-danger top-btn' data-toggle="tooltip" data-placement="top" title="Add Pick up" ><span class="mdi mdi-clock-fast"></span></a>													
												<?php } ?>	
												</td>
											</tr>
											<?php endforeach;?>
