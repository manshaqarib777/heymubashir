            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../uploads/<?php echo ($row->avatar) ? $row->avatar : "blank.png";?>" class="rounded-circle" width="50" height="50" />&nbsp; <i class="fa fa-caret-down"></i></a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <span class="with-arrow"><span class="bg-primary"></span></span>
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class=""><img src="../uploads/<?php echo ($row->avatar) ? $row->avatar : "blank.png";?>" class="rounded-circle" width="80" height="80" /> </div>
                                    <div class="m-l-10">
