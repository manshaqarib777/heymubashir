<?php
	...
	if (isset($_GET['tgl_awal'])) {
		$no    = 1;
		$query = mysqli_query($con, "SELECT * FROM add_courier WHERE origin_off='".$row->name_off."' AND status_courier='Rejected' AND status_novelty='0' AND  created  BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id ASC") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>REJECTED SHIPPING REPORT</title>
    ...
    <body>
	   ...
	   <br>
	   <div id="title">
           Shipments rejected | Employee: <?php echo $used; ?>
        </div>
...
<?php
$filename="rejected shipment.pdf"; 
