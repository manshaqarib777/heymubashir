...
<?php $courierrow = $core->getCourier_list_intrasit(); ?>
		...
		<div class="card">
			...
			<div class="d-md-flex align-items-center">
				<div>
					...
					<h5 class="card-subtitle">Selected state: In Transit</h5>
				</div>
			</div>

				<ul class="nav nav-pills m-t-30 m-b-30">
					<li class=" nav-item"> <a href="index.php" class="nav-link"><h5 class="card-title"><?php echo $lang['shipearrin'] ?></h5></a> </li>
					<li class="nav-item"> <a href="all_status.php?do=status_in_transit" class="nav-link active"><h5 class="card-title">In Transit </h5></a> </li>
