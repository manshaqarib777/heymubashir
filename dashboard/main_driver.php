...
<?php $row = Core::getRowById(Users::uTable, Filter::$id);?>
	...
	<div class="row">
		...
		<div class="col-lg-4 col-xlg-3 col-md-5">
			<div class="card">
				<div class="card-body">
					<center class="m-t-30"> <img src="../uploads/<?php echo ($row->avatar) ? $row->avatar : "blank.png";?>" class="rounded-circle" width="150" />
					...
					<div class="tab-pane fade show active" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
						...
						<div id="msgholder"></div>
							<form class="form-horizontal form-material" id="admin_form" method="post">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="enrollment" value="<?php echo $row->enrollment;?>" placeholder="<?php echo $lang['edit-clien59'] ?>">
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label for="phoneNumber1"><?php echo $lang['edit-clien60'] ?></label>
												<input type="text" class="form-control" name="vehiclecode" value="<?php echo $row->vehiclecode;?>" placeholder="<?php echo $lang['edit-clien60'] ?>">
											</div>
										</div>
									</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="custom-select form-control"  name="userlevel">
													<?php echo $user->getDriverLevels($row->userlevel);?>
												</select>
											</div>
										</div>
										<div class="col-md-5">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<br>
												<img src="../uploads/<?php echo ($row->avatar) ? $row->avatar : "blank.png";?>" class="avatar" width="50" />
											</div>
										</div>
									</div>
								...
								<div class="form-group">
									<div class="col-sm-12">	
										<button class="btn btn-outline-primary btn-confirmation" name="dosubmit" type="submit"><?php echo $lang['edit-clien57'] ?><span><i class="icon-ok"></i></span></button>
										<a href="driver.php?do=main_driver" class="btn btn-outline-secondary btn-confirmation"><span><i class="ti-share-alt"></i></span> <?php echo $lang['edit-clien30'] ?></a>
									</div>
...
<?php echo Core::doForm("processDriver");?>
<?php break;?>
<?php case"add": ?>
				...
				<div class="tab-pane fade show active" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
					...
					<div id="loader" style="display:none"></div>
						...
						<form class="form-horizontal form-material" id="admin_form" method="post">
							<section>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label for="emailAddress1"><?php echo $lang['edit-clien59'] ?></label>
											<input type="text" class="form-control" name="enrollment"  placeholder="<?php echo $lang['edit-clien59'] ?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="phoneNumber1"><?php echo $lang['edit-clien60'] ?></label>
											<input type="text" class="form-control" name="vehiclecode"  placeholder="<?php echo $lang['edit-clien60'] ?>">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label for="emailAddress1"><?php echo $lang['edit-clien36'] ?></label>
											<textarea class="form-control" name="notes" rows="6"  name="notes" placeholder="<?php echo $lang['edit-clien36'] ?>"></textarea>
										</div>
									</div>
								</div>
							...
							<div class="form-group">
								<div class="col-sm-12">										
									<button class="btn btn-outline-primary btn-confirmation" name="dosubmit" type="submit"><?php echo $lang['edit-clien51'] ?><span><i class="icon-ok"></i></span></button>
									<a href="driver.php?do=main_driver" class="btn btn-outline-secondary btn-confirmation"><span><i class="ti-share-alt"></i></span> <?php echo $lang['edit-clien30'] ?></a> 
								</div>
							</div>
						</form>
					...
					<table id="zero_config" class="table table-condensed table-hover table-striped">
						...
						<div class="m-t-40">
							<div class="d-flex">
								<div class="mr-auto">
									<div class="form-group">
										<a href="driver.php?do=main_driver&amp;action=add"><button type="button" class="btn btn-primary btn"><i class="ti-plus" aria-hidden="true"></i> <?php echo $lang['edit-clien48'] ?></button></a>
									</div>
								</div>
							</div>
						</div>
						<tbody id="projects-tbl">
							...
							<tr>
								...
								<td  class="text-center"><i class="icon-prepend icon-truck"></i> <?php echo $row->enrollment;?></td>
								<td  class="text-center"><i class="icon-prepend icon-tag"></i> <?php echo $row->vehiclecode;?></td>
								...
								<td align='center'>
									<a  href="driver.php?do=main_driver&amp;action=edit&amp;id=<?php echo $row->id;?>" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['edit-clien46'] ?>"><i style="color:#343a40" class="ti-pencil"></i></a>
									<a   href="driver.php?do=newsletter&amp;emailid=<?php echo urlencode($row->email);?>"  data-toggle="tooltip" data-placement="top" title="<?php echo $lang['edit-clien45'] ?>"><i style="color:#343a40" class="ti-email"></i></a>
									<?php if($row->id == 1):?>
