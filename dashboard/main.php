				...
				<div class="card">
					<div class="card-body">
						<center class="m-t-30"> <img src="../uploads/<?php echo ($row->avatar) ? $row->avatar : "blank.png";?>" class="rounded-circle" width="150" />
							...
							<h6 class="card-subtitle"><span>Sucursal <i class="icon-double-angle-right"></i></span>  <div class="badge badge-pill badge-light font-16">	<?php echo $row->name_off;?></div></h6>
						</center>
					</div>
					<div><hr> </div>
								...
								<form class="form-horizontal form-material" id="admin_form" method="post">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input class="custom-select col-12" id="exampleFormControlSelect1" name="name_off" list="browsers1" autocomplete="off" value="<?php echo $row->name_off; ?>" >
													<datalist id="browsers1">
														<?php foreach ($office as $roww):?>
															<option value="<?php echo $roww->name_off; ?>"><?php echo $roww->name_off; ?></option>
														<?php endforeach;?>
													</datalist>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label for="firstName1">Office group</label>
													<input class="form-control" name="name_off" value="<?php echo $user->name_off; ?>" readonly>
												</div>
											</div>
											<?php } ?>	
									...
									<div class="form-group">
										<div class="col-sm-12">	
											...
											<a href="all_tools.php?do=main" class="btn btn-outline-secondary btn-confirmation"><span><i class="ti-share-alt"></i></span> <?php echo $lang['user_manage30'] ?></a>
										</div>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="custom-select col-12" id="exampleFormControlSelect1" name="name_off" placeholder="Branch Offices">
						...
						<table id="zero_config" class="table table-condensed table-hover table-striped" data-pagination="true" data-page-size="5">
							...
							<div class="m-t-40">
								<div class="d-flex">
									<div class="mr-auto">
										<div class="form-group">
											<a href="all_tools.php?do=main&amp;action=add"><button type="button" class="btn btn-primary btn"><i class="ti-plus" aria-hidden="true"></i> <?php echo $lang['user_manage44'] ?></button></a>
										</div>
									</div>
								</div>
							</div>
							<tbody id="projects-tbl">
								...
								<tr>
									...
									<td align='center'>
										<a  href="all_tools.php?do=main&amp;action=edit&amp;id=<?php echo $row->id;?>" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['edit-clien46'] ?>"><i style="color:#343a40" class="ti-pencil"></i></a>
										<a   href="all_tools.php?do=newsletter&amp;emailid=<?php echo urlencode($row->email);?>"  data-toggle="tooltip" data-placement="top" title="<?php echo $lang['edit-clien45'] ?>"><i style="color:#343a40" class="ti-email"></i></a>
										<?php if($row->id == 1):?>
										<a id="item_<?php echo $row->id;?>" data-rel="<?php echo $row->username;?>" data-toggle="tooltip" data-placement="top" title="Master Admin"><i style="color:#343a40" class="ti-lock"></i></a>
										<?php else:?>
